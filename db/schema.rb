...
ActiveRecord::Schema.define(version: 20170829123038) do
  ...
  create_table "admin_qoutes", force: :cascade do |t|
    t.text     "description"
    t.boolean  "enable"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    ...
    t.index ["setting_id"], name: "index_admin_qoutes_on_setting_id", using: :btree
  end
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.boolean  "on_professional_page",                  default: false
    t.boolean  "same_description_on_professional_page", default: false
  ...
  create_table "photos_tools", id: false, force: :cascade do |t|
    t.integer "photo_id", null: false
    t.integer "tool_id",  null: false
    t.index ["photo_id"], name: "index_photos_tools_on_photo_id", using: :btree
    t.index ["tool_id"], name: "index_photos_tools_on_tool_id", using: :btree
  end

  create_table "photos_tools_tables", force: :cascade do |t|
  end
